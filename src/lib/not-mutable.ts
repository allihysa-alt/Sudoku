...
// Tiny subset of immutable.js. Phase 4 swaps the engine's reliance on
// this shim for Zustand+Immer at the state layer; the shim stays in
// place during Phase 3 so the engine port is verbatim and tests pass
